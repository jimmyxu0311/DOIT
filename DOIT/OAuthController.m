...
- (void) loadView {
    ...
    [_navBar setBackgroundImage:[UIImage imageNamed:@"topbar01"] forBarMetrics:UIBarMetricsDefault];
    ...
    _webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 44, 320, self.view.frame.size.height - 44)];
	_webView.alpha = 0.0;
	...
	label.text = NSLocalizedString(@"请等待…", nil);

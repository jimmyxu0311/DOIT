...
- (NSURLRequest *) authorizeURLRequest {
   ...
   // NSLog(@"_requestToken.key = %@, _requestToken.secret = %@",_requestToken.key,_requestToken.secret);
   ...
   // NSLog(@"self.authorizeURL = %@, _requestToken = %@",self.authorizeURL,_requestToken);
